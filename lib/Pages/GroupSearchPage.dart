    ...
    return ListTile(
      ...
      trailing: InkWell(
        onTap: () async {
          ...
          if(_isJoined) {
            ...
            Future.delayed(Duration(milliseconds: 2000), () {
              Navigator.of(context).push(MaterialPageRoute(builder: (context) => GroupChatPage(groupId: groupId, userName: userName, groupName: groupName)));
            });
          }
          else {
            setState(() {
        ...
        Container(
          ...
          padding: EdgeInsets.symmetric(horizontal: 20.0, vertical: 10.0),
          child: Text(AppLocalizations.of(context).joinLabel, style: TextStyle(color: Colors.white)),
        ),
      ),
    );
  }
